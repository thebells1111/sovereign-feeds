<script>
		...
		return {
			...
			set: (d) => {
				...
				if (d === null) {
					...
					d.getTime() !==
					($innerStore === null || $innerStore === void 0 ? void 0 : $innerStore.getTime())
				) {
					innerStore.set(d);
					value = d;
				}
	...
	function onFocusOut(e) {
		if (
			(e === null || e === void 0 ? void 0 : e.currentTarget) instanceof HTMLElement &&
			e.relatedTarget &&
...
<style>
	...
	input {
		...
		border-radius: 3px;
		width: var(--date-input-width, 120px);
		outline: none;
