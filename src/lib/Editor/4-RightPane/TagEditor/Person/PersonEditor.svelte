				...
				<div class="person-block">
					...
					<div class="role-container">
						<div class="role-select-container">
							<label style="width: 100%" class="themed">
								<h4>Group</h4>
...
<style>
	...
	.add-new-cast {
		min-width: 75px;
		min-height: 75px;
		border: 1px solid var(--add-cast-border-color);
		border-radius: 75px;
		font-size: 3em;
		align-self: center;
		display: flex;
		...
		cursor: pointer;
		background-color: var(--add-cast-bg-color);
	}
	...
	.themed {
		...
		--borderFocusColor: var(--input-select-color);
		--listBackground: var(--input-color);
		--itemHoverBG: var(--input-hover-color);
	...
	input:focus {
		outline: none;
		border: 1px solid var(--input-select-color);
	}
